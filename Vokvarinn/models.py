...
class Plants(BaseModel):
    ...
    last_water = models.DateTimeField(default=timezone.now, verbose_name='Last water', editable=True, blank=True, null=True)
    info_url = models.URLField(max_length=200, null=True, blank=True, verbose_name='Info url', default="http://www.wikipedia.org")
    ...
    image = models.ImageField(null=True, blank=True, upload_to="static/plant_images/", verbose_name="Image", default="DefaultPlant.jpg")
...
class PlantImages(models.Model):
     plant = models.ForeignKey(Plants, default=1, on_delete=models.SET_DEFAULT, verbose_name='Plant name')
     image = models.ImageField(blank=True, upload_to="static/plant_images/", verbose_name="Image", default="PlantImagesTEST.jpg")
