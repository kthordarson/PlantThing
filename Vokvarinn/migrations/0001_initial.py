# Generated by Django 2.2.4 on 2019-08-19 15:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_id', models.ImageField(blank=True, default='DefaultPlant.jpg', null=True, upload_to='static/plant_images/', verbose_name='Image')),
                ('water_schedule', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='djcelery.IntervalSchedule', verbose_name='Watering schedule')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(blank=True, default='PlantImagesTEST.jpg', null=True, upload_to='static/plant_images/', verbose_name='Image')),
                ('plant', models.ForeignKey(default=1, on_delete=django.db.models.deletion.SET_DEFAULT, to='Vokvarinn.Plants', verbose_name='Plant name')),
            ],
            options={
